...
#include <igl/opengl/glfw/Viewer.h>
 ...
 bool my_collapse_edge(
    ...
    Eigen::MatrixXi& EF,
    Eigen::MatrixXi& EI,
    std::vector<Eigen::Matrix4d>& q_vertices_vector,
...
{
    int e1, e2, f1, f2;
    return my_collapse_edge(e, p, V, F, E, EMAP, EF, EI, q_vertices_vector, e1, e2, f1, f2);
}
    ...
    Eigen::MatrixXd& C)
{
    ...
    return
        my_collapse_edge(
            ...
            V, F, E, EMAP, EF, EI, q_vertices_vector, Q, Qit, C ,e, e1, e2, f1, f2);
}
    ...
    int& f2)
{
    ...
    bool collapsed = true;
    if (pre_collapse(V, F, E, EMAP, EF, EI, q_vertices_vector, Q, Qit, C, e))
    {
        collapsed = my_collapse_edge(e, C.row(e), V, F, E, EMAP, EF, EI, q_vertices_vector, e1, e2, f1, f2);
    }
    else
    {
    ...
    post_collapse(V, F, E, EMAP, EF, EI, q_vertices_vector, Q, Qit, C, e, e1, e2, f1, f2, collapsed);
    if (collapsed)
    {
        ...
        Q.erase(Qit[e2]);
        Qit[e2] = Q.end();
        q_vertices_vector[v3] = q_vertices_vector[v1] + q_vertices_vector[v2];
        ...
        for (auto n : N)
        {
                ...
                F(n, 2) != IGL_COLLAPSE_EDGE_NULL)
            {
                for (int v = 0; v < 3; v++)
                {
                    ...
                    double cost;
                    RowVectorXd place;
                    cost_and_placement(ei, V, F, E, EMAP, EF, EI, q_vertices_vector, cost, place);
                    // Replace in queue
